...
public class Vec2d {
    ...
    /**
     * Returns the distance from this Vec2d to
     * a specified point.
     *
     * @param vx the X coordinate of the specified point to be measured
     *           against this Vec2d
     * @param vy the Y coordinate of the specified point to be measured
     *           against this Vec2d
     * @return the distance between this Vec2d
    ...
    /**
     * Returns the distance from this Vec2d to a
     * specified Vec2d.
     *
     * @param v the specified point to be measured
     *           against this Vec2d
     * @return the distance between this Vec2d and
     * the specified Vec2d.
     */
     ...
     * @return      a hash code for this Vec2d.
     */
    @Override
    public int hashCode() {
        long bits = 7L;
     ...
     * Two instances of Vec2d are equal if the values of their
     * x and y member fields, representing
     * their position in the coordinate space, are the same.
     * @param obj an object to be compared with this Vec2d
     * @return true if the object to be compared is
     *         an instance of Vec2d and has
